        ...
        <Layout title="Register - Ecommerce App">
            <div className="form-container">
                ...
                <h1 className='title'>Register Page</h1>
                    ...
                    <div className="mb-3">
                        <input type="text" value={answer} onChange={(e)=> setAnswer(e.target.value)} className="form-control" id="exampleInputanswer" placeholder="What is your Favorite Sports" required/>
                    </div>
